...
ActiveRecord::Schema.define(version: 20140120043326) do
  ...
  create_table "seasons", force: true do |t|
    ...
    t.boolean "lockdown_winner", default: false
  end
  ...
  create_table "weekly_entries", force: true do |t|
    ...
    t.integer "final_rose_distance", default: 0
    t.integer "standing"
  end
